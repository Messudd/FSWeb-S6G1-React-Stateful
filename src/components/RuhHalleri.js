...
export default function RuhHalleri() {
  ...
  return (
    <div className='widget-moods container'><span style={{fontWeight : 'bold' , fontSize :'1.5em'}}>Moods :</span> 
      <h2>RuhHalleri</h2>
	    <div id='ruhHali' style={ruhHali === ilkRuhHali || ruhHali === uzgunRuhHali ? stil_other : stil}>{ruhHali}
      </div>
      <div>
